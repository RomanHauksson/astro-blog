...
*(2026 January 24 update):* In the 2.5 years since I made this project, AI has advanced enough that startups like [Suno](https://suno.com/home) are actively trying to take over the music industry by automating music generation. I think this is an unpleasant development, and in hindsight, even though this project was just a simple experiment, it was in bad taste.

---

I wanted to recreate [MF DOOM](https://en.wikipedia.org/wiki/MF_Doom)\'s prose because it\'s famously dense with rhyme, wordplay, and pop culture references. ChatGPT can already generate lyrics as sophisticated as [Lil Pump](https://en.wikipedia.org/wiki/Lil_Pump)'s using [zero-shot prompting](https://www.promptingguide.ai/techniques/zeroshot), but is it possible to use more advanced methods to coax a language model into generating lyrics of MF DOOM\'s caliber?
...
He doesn\'t sound *exactly* like DOOM, and his flow is off-beat, even after I played around with [quantization](https://en.wikipedia.org/wiki/Quantization_(music)).

*The lyrics and the final song Metal Mask are a
